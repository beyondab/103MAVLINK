...
#define MAVLINK_COMMON_XML_HASH 3566473043808720733
...
typedef enum MAV_SYS_STATUS_SENSOR
{
   ...
   MAV_SYS_STATUS_EXTENSION_USED=2147483646, /* 0x80000000 Extended bit-field are used for further sensor status bits (needs to be set in onboard_control_sensors_present only) | */
...
typedef enum HIL_SENSOR_UPDATED_FLAGS
{
   ...
   HIL_SENSOR_UPDATED_RESET=2147483646, /* Full reset of attitude/position/velocities/etc was performed in sim (Bit 31). | */
